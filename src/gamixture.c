...
int gaInitializePopulation(Population* pop,int size, int dim, int numberOfLabels,int numberOfPveLabels,
                           LabelType* labelTypes, float* lowLimit, float* upLimit, bool equalVar)
{
  int i,j;
  int mixtureSize;
  int bgVar;
...
void gaBLX(Population* pop,Population* selPop,float xoverRate, int elitism, float alpha, float* lowLimit, float* upLimit, bool equalVar)
{
  int i,j;
  int leaveAlone;
  int mixtureSize;
